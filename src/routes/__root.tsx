  ...
  head: () => ({
    meta: [
      ...
      { title: "AyuSetu — Your Health Story, Clearly Understood." },
      {
        name: "description",
        content:
          "AI-assisted patient case taking that helps patients share health information and helps doctors prepare for better in-person consultations.",
      },
      { name: "author", content: "AyuSetu" },
